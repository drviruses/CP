...
void virus(){
       ll num, k;
       cin>>num>>k;
       ll pos1 = lower_bound(arr.begin(),arr.end(),k) - arr.begin() + 1;
       ll pos2 = pos1 - (arr[pos1 - 1] - k) - 1;
       for(auto i=1; i<=num; i++) if((num - i == pos1) || (num - i == pos2)) cout<<"b"; else cout<<"a";
       cout<<endl; 
}
